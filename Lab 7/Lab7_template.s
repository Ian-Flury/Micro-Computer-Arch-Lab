...
Scan_Col_1
	...
	PUSH	{LR, R1, R0}
	MOV		R1, ; TO DO: Write the immediate value needed to have PA3=1 and PA2, PA4, PA5 are 0's	
	LDR		R0, =GPIO_PORTA_DATA_R
	STR		R1, [R0]
...
Found_key_2
	LDR		R0, =Key_ASCII
	MOV		R1, ; TO DO: immediate ASCII value of '2'
	STR		R1, [R0]
	B		Scan_Col_1_done	; 
Found_key_5
	LDR		R0, =Key_ASCII
	MOV		R1, ;TO DO: immediate ASCII value of '5'
	STR		R1, [R0]
	B		Scan_Col_1_done	;
Found_key_8
	LDR		R0, =Key_ASCII
	MOV		R1, ;TO DO: immediate ASCII value of '8'
	STR		R1, [R0]
	B		Scan_Col_1_done	;
Found_key_0
	LDR		R0, =Key_ASCII
	MOV		R1, ;TO DO: immediate ASCII value of '0'
	STR		R1, [R0]
Scan_Col_1_done
	POP		{LR, R1, R0}
	BX		LR
...
Scan_Col_2
	PUSH	{LR, R1, R0}
	MOV		R1, ; TO DO: immediate value to set PA4=1 and PA2, PA3, PA5 are 0's
	LDR		R0, =GPIO_PORTA_DATA_R
	STR		R1, [R0]
...
Found_key_3
	LDR		R0, =Key_ASCII
	MOV		R1, ;TO DO: immediate ASCII value of '3'
	STR		R1, [R0]
	B		Scan_Col_0_done	; 
Found_key_6
	LDR		R0, =Key_ASCII
	MOV		R1, ;TO DO: immediate ASCII value of '6'
	STR		R1, [R0]
	B		Scan_Col_0_done	;
Found_key_9
	LDR		R0, =Key_ASCII
	MOV		R1, ;TO DO: immediate ASCII value of '9'
	STR		R1, [R0]
	B		Scan_Col_0_done	;
Found_key_pound
	LDR		R0, =Key_ASCII
	MOV		R1, ;TO DO: immediate ASCII value of '#'
	STR		R1, [R0]
Scan_Col_2_done
	POP		{LR, R1, R0}
	BX		LR
...
Scan_Col_3
	PUSH	{LR, R1, R0}
	MOV		R1, ; TO DO: immediate value to set PA5=1 and PA2-PA4 are 0's
	LDR		R0, =GPIO_PORTA_DATA_R
	STR		R1, [R0]
